...
import { ChevronLeft, MessageCircle, Calendar, User } from 'lucide-react'
import { IoLocationOutline, IoTimeOutline, IoPersonOutline } from 'react-icons/io5'
import useApplicationsStore from '../stores/applicationsStore'

export default function Applications() {
  const navigate = useNavigate()
  const { appliedActivities, cancelApplication, isApplied } = useApplicationsStore()
  ...
  // 신청 취소 함수
  const handleCancelApplication = async (activity, e) => {
    e.stopPropagation() // 카드 클릭 이벤트 방지
    await cancelApplication(activity.id)
  }
  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <HeaderTitle>신청한 활동</HeaderTitle>
      </Header>
        ...
        <ContentWrapper>
          {appliedActivities.length > 0 ? (
              ...
              {appliedActivities.map(activity => (
                <ActivityCard key={activity.id}>
                  ...
                  <CardContent>
                    ...
                    <AppliedDate>
                      <Calendar size={16} />
                      <span>신청일: {formatAppliedDate(activity.appliedAt)}</span>
                    </AppliedDate>
                    ...
                    <ActionButtons>
                      ...
                      <CancelButton onClick={(e) => handleCancelApplication(activity, e)}>
                        신청 취소
                      </CancelButton>
                    </ActionButtons>
                  </CardContent>
            ...
            <EmptyState>
              ...
              <EmptyTitle>신청한 활동이 없습니다</EmptyTitle>
              <EmptyDescription>
                함께할 활동을 찾아 신청해보세요!
              </EmptyDescription>
